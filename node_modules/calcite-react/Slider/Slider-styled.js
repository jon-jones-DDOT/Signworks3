...
var rangeProps = {
  ...
  trackErrorHoverBgcolor: _CalciteThemeProvider.CalciteTheme.palette.darkRed200,
  trackActiveBgcolor: _CalciteThemeProvider.CalciteTheme.palette.gray,
  trackErrorActiveBgcolor: _CalciteThemeProvider.CalciteTheme.palette.darkRed,
  thumbHeight: '18px',
  thumbWidth: '18px',
  thumbBorder: '2px solid',
  thumbBorderColor: _CalciteThemeProvider.CalciteTheme.palette.gray,
  thumbErrorBorderColor: _CalciteThemeProvider.CalciteTheme.palette.darkRed200,
  thumbBorderHoverColor: _CalciteThemeProvider.CalciteTheme.palette.Brand_Blue_200,
  thumbErrorBorderHoverColor: _CalciteThemeProvider.CalciteTheme.palette.darkRed200,
  ...
  thumbErrorBgHover: _CalciteThemeProvider.CalciteTheme.palette.darkRed200,
  thumbBgActive: _CalciteThemeProvider.EsriColors.Calcite_Blue_a250,
  thumbErrorBgActive: _CalciteThemeProvider.CalciteTheme.palette.darkRed
};
...
var StyledSlider = (0, _styledComponents.default)(_commonElements.CalciteInput).withConfig({
  ...
  return (props.error || props.success) && (0, _styledComponents.css)(["border-color:transparent;padding-right:0;background-image:none;&:focus{border-color:transparent;box-shadow:none;}"]);
}, function (props) {
