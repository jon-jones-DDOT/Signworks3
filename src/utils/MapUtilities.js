define(["esri/geometry/support/webMercatorUtils",
    "esri/geometry/SpatialReference",
    "esri/tasks/GeometryService",
    "esri/geometry/Extent",
    "esri/tasks/support/ProjectParameters"], function (webMercatorUtils,
        SpatialReference,
        GeometryService,
        Extent,
        ProjectParameters) {
        ...
        return {
            ...
            projectPoint: function (point, SR, callback) {
                ...
                gsvc.project(params).then(function (results){callback(results)} )
            },
